        # Ipd Meta Pro: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/ipd-meta-pro.git

        ## Objective

        IPD-Meta-Pro is a 51K-line browser-based individual patient data meta-analysis platform with WebR validation, supporting one-stage and two-stage IPD models.
        ...
        - Code: https://github.com/mahmood726-cyber/ipd-meta-pro.git
        - Dashboard: https://mahmood726-cyber.github.io/ipd-meta-pro/
